...
use crate::grpc_wrapper::raw_query_service::value::r#type::RawType;
...
pub(crate) struct RawValuePair {
    pub(in crate::grpc_wrapper::raw_query_service) key: RawValue,
    pub(in crate::grpc_wrapper::raw_query_service) payload: RawValue,
}

#[derive(Clone, Debug, PartialEq, serde::Serialize)]
pub(crate) struct RawVariantValue {
    pub(in crate::grpc_wrapper::raw_query_service) value: RawValue,
    pub(in crate::grpc_wrapper::raw_query_service) index: u32,
}
